...
export default function ServicesGrid() {
  return (
    <section className="py-24 bg-brand-bg" id="services-grid">
      <div className="custom-container">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-2xl">
            <p className="text-sm font-bold text-brand-primary uppercase tracking-widest mb-3">Our Services</p>
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              Complete WordPress Solutions for Your Business
            </h2>
          </div>
          <Link to="/services" className="inline-flex items-center text-brand-primary font-bold hover:translate-x-2 transition-transform">
          ...
          {SERVICES.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="group p-8 rounded-3xl border border-white/5 bg-white/5 hover:border-brand-primary/50 hover:bg-white/[0.08] transition-all duration-300 relative overflow-hidden"
              >
