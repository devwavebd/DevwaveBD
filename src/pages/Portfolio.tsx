                ...
                <div className="relative h-[320px] sm:h-[400px] md:h-[520px] rounded-[2rem] md:rounded-[2.5rem] overflow-hidden border border-white/10 bg-white/5 shadow-2xl flex flex-col">
                  ...
                  <div className="relative flex-1 overflow-hidden group/img bg-white/[0.02]">
                    ...
                    <img
                      src={project.image}
                      alt={project.title}
                      className="w-full h-auto absolute top-0 left-0 transition-transform duration-[8000ms] ease-in-out group-hover:translate-y-[calc(-100%+250px)] sm:group-hover:translate-y-[calc(-100%+350px)] md:group-hover:translate-y-[calc(-100%+450px)] will-change-transform"
